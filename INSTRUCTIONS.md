...
[x] Add answer to DOM after submitting values
[x] Create GET request to display list of equations on the DOM

On the server:
[x] Built out server-side logic to compute each equation 
[x] Create array that will serve as historical record of all math operations and solutions
